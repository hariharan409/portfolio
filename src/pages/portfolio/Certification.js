        ...
        <div style={{marginTop: "20px"}}>
            ...
            <div className="certification-element">
                ...
                return  <div key={certification.id} className="certification-element-item" style={{paddingTop: "20px",paddingBottom: "70px"}}>
                            ...
                            <img src={certification.learningPlatformImage} alt="certificate-pic" style={{width: "80px",borderRadius: "50%",marginBlock: "10px"}} />
                            ...
                            <a href={certification.certificationLink} target="_blank" rel="noreferrer">
